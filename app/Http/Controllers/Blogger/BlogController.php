...
class BlogController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('can:blog-edit')->only('edit',);
        $this->middleware('can:blog-edit')->only('update');
        $this->middleware('can:blog-add')->only('create');
        $this->middleware('can:blog-add')->only('store',);
    ...
    public function create()
    {
        ...
        return view('blog.create', compact('pageName', 'categories', 'authors', 'publishers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('blog.edit', compact('pageName', 'data', 'categories', 'authors', 'publishers'));
    }
