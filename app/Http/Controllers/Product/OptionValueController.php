...
class OptionValueController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('option-value.index', compact('pageName'));
    }
    ...
    public function create()
    {
        ...
        return view('option-value.create', compact('pageName', 'options'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('option-value.edit', compact('pageName', 'data', 'options'));
    }
