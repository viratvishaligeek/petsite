          ...
          features: [
            ...
            },
            {
              geometry: {
                type: 'Polygon',
                coordinates: [
                  '@@guûƿcy¤«£ŇR§èöcĘÐOōiƃ͇͟ϟչȕů˃LǇԮZپǭ˪ôľʎǳʶ^ƜàÀ̈́ǀÝʔĔŨñ'
                ],
            ...
            },
            {
              geometry: {
                type: 'Polygon',
                coordinates: [
                  '@@ʦq̈ʣȋ˥wAá\\ğí£Í}©͋ʁw՝ɸ£̪ɯǉͫVtɴСºÿƞ˓°Ɠȼ̇{ȟ̆ۚɾèōЂ˘ƮڰêƸǅӨŁđͅ'
                ],
            ...
            },
            {
              geometry: {
                ...
                coordinates: [
                  ['@@āYĉǀĔưƎǑÕƃ'],
                  ['@@٫SȧϨݵĚƌƎÚôŘǆȰϴиĆĠiȎÿvŭŚəƣȹȉˢ͢ڿ']
                ],
            ...
            },
            {
              geometry: {
                type: 'Polygon',
                coordinates: [
                  '@@аˏƖɇó͹ōI·ŹķġkʹǅwǵƱŷ¯©wԣeɉàȃ̂ÞԎƆ@¬ǔʂĎȐÑĒĶƠxB@Ɇ²ѼV'
                ],
            ...
            },
            {
              geometry: {
                type: 'Polygon',
                coordinates: [
                  '@@Ħ»eɛÄȧNˍóz}MwţkǳZŏǹGɯ^Ǐ´ǯłĿǔ¯ļÛNYlR̎ʈζĴŚņô ZGьȇvX'
                ],
            ...
            },
            {
              geometry: {
                type: 'Polygon',
                coordinates: [
                  '@@řԛӈ͝²ՓǸʽrႫÿIȺוŽßλŃϙ̨ǯͰĞцœǊƾڸˁͼĮüҢʗÄĠŠßĮլϻ͎Ą̈ßĂҾƉ΄'
                ],
            ...
            },
            {
              geometry: {
                ...
                coordinates: [
                  ...
                  ['@@īҍđÚvψǈl'],
                  [
                    '@@Ḯ႗ϝപ৏ΕୃÎɗ֠׉ɏгCɧŢsZǕŗεŮнǄȿìڵبϵЋ̙ƟûۡɉзȷӑĴǏʉƷāƙͥŦ֡ŝī_¾ýÒƝêŁDŻŉÉgũfȡRȉGmĬÎĭ¬ƓɖºʎćҪȽђ˙Ȥęƥ߿ɚƏîہɦqĦhËjŧMįĔěŶć ɱIĝ¼ÛÞ½öğʀ˃զÿɎčƔęĺŧĦƍĤõÚĳȈ¥äŢuŮVºĘǄV¬YÔ©ŶǙѢeìDÂà˶A ˆKȔŰϠպ͈͠jƄ}ŎÑPėõd¹rmfQ¨¤ň£¬c2cüǀhvFÂp¸T OÈvÖlĺWĊÞKͼ§Ė©¾ß|ĽƆÞN¢bTHŸXÎÊZ^GlG౶@ಀ@'
                  ]
                ],
                encodeOffsets: [
                  [[40665, -8168]],
