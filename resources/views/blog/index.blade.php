        ...
        <div class="mb-4">
            <div class="row g-3">
                ...
                <div class="col-auto">
                    ...
                    @can('blog-add')
                        <a href="{{ route('admin.blog.create') }}" class="btn btn-primary"> <span class="fas fa-plus me-2">
                            </span> Add</a>
                    @endcan
                </div>
            </div>
                    ...
                    <table id="dataTable" class="table fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="white-space-nowrap align-middle ">Category</th>
                                <th class="white-space-nowrap align-middle ">Tenant</th>
                                <th class="white-space-nowrap align-middle ">Author </th>
                                <th class="white-space-nowrap align-middle ">Publisher</th>
