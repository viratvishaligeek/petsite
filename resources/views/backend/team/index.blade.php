        ...
        <div class="mb-4">
            <div class="row g-3">
                ...
                <div class="col-auto">
                    ...
                    @can('team-add')
                        <a href="{{ route('admin.team.create') }}" class="btn btn-primary"> <span class="fas fa-plus me-2">
                            </span> Add</a>
                    @endcan
                </div>
            </div>
                    ...
                    <table id="dataTable" class="table fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="white-space-nowrap align-middle ">Encoded Phone </th>
                                <th class="white-space-nowrap align-middle ">Role</th>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            initializeDataTable('#dataTable', "{{ route('admin.team.index') }}", columns, 'Team Members');
        });
    </script>
@endsection
