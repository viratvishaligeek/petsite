        ...
        <div class="mb-4">
            <div class="row g-3">
                ...
                <div class="col-auto">
                    ...
                    @can('tenant-add')
                        <a href="{{ route('admin.tenant.create') }}" class="btn btn-primary"> <span class="fas fa-plus me-2">
                            </span> Add</a>
                    @endcan
                </div>
            </div>
                    ...
                    <table id="dataTable" class="table fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="white-space-nowrap align-middle">Tenant Name</th>
                                <th class="white-space-nowrap align-middle ">Domain </th>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            initializeDataTable('#dataTable', "{{ route('admin.tenant.index') }}", columns, 'Tenants List');
        });
    </script>
@endsection
